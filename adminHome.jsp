...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact the Developer.
Designed & Developed by Ragavi</h5></center>
  <hr class="new1">
<center><h5>Trust The Process , So No Need To Worry About The Result 2019 - 2023</h5></center> 
  <hr class="new1">
<br>
</body>
</html>